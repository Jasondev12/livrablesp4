...
<div class="container">
    ...
    <blockquote>
        ...
        <a href="index.php?admin=option&s_cmt=<?= $comment['id'] ?>"> <button class="btn light red">Signaler</button> </a>
    </blockquote>
    <?php
                    }
            ?>
    ...
    <div class="return">
        <div class="returnpost">
            <a href="index.php?client=blog" class="btn-floating light-blue  pulse"><i class="material-icons">keyboard_return</i></a>
        </div>
