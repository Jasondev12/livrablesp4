        ...
        <div class="col s12">
            ...
            <div class="row">
                ...
                <div class="col s12 m6 l4">
                    ...
                    <br /><br />
                    <a class="btn light-blue waves-effect waves-light" href="index.php?admin=upost&id=<?= $post['id'] ?>">Modifier</a>
                    <a class="btn light-red " href="index?admin=options&del_post=<?= $post['id'] ?>">Supprimer</a>
                </div>
            </div>
        </div>
    </div>
